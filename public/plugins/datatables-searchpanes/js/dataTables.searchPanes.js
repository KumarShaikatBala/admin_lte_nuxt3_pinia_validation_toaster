...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._setListeners = function () {
            ...
            if (this.s.firstSet) {
                ...
                // When saving the state stores all of the selected rows for preselection next time around
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            // Whenever a state save occurs stores the selection list in the state object
            this.s.dt.on('stateSaveParams.dtsp', function (e, settings, data) {
                if (data.searchPanes === undefined) {
                    data.searchPanes = {};
                }
